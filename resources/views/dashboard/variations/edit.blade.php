    ...
    <div class="col-md-12">
        ...
        <div class="card card-info">
            ...
            <div class="card-header">
                ...
                <h3 class="card-title">Editer la variation</h3>

            </div>

            {!! Form::model($variation, ['route' => ['variation.update', $variation->id], 'method' => 'PUT']) !!}
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        {!! Form::select('state_id', $states, $variation->state_id, ['class' => 'form-control select2', 'required' => true, 'placeholder' => 'Choisissez un état']) !!}
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        {!! Form::select('packing_id', $packings, $variation->packing_id, ['class' => 'form-control select2', 'required' => true, 'placeholder' => 'Choisissez un conditionnement']) !!}
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        {!! Form::select('product_id', $products, $variation->product_id, ['class' => 'form-control select2', 'required' => true, 'placeholder' => 'Choisissez un produit']) !!}
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        {!! Form::text('name', $variation->name, ['class' => 'form-control', 'required' => true]) !!}
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        {!! Form::text('sku', $variation->sku, ['class' => 'form-control']) !!}

                    </div>

                    <span class="text-danger text-sm">{{ $errors->first('sku') }}</span>

                    @if (session('sku_already_registered'))

                        <span class="text-danger text-sm">
                            {{ session('sku_already_registered') }}
                        </span>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        {!! Form::number('price', $variation->price, ['class' => 'form-control', 'min' => 0, 'required' => true]) !!}
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        {!! Form::number('stock', $variation->stock, ['class' => 'form-control', 'min' => 0, 'required' => true]) !!}
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        {!! Form::number('units_sold', $variation->units_sold, ['class' => 'form-control', 'min' => 0, 'required' => true]) !!}
                ...
                <div class="form-group">
                    ...
                    {!! Form::textarea('description', $variation->description, ['class' => 'd-none summernote', 'required' => true]) !!}
                ...
                <div class="form-group">
                    ...
                    @php
                        $valueOne = $variation->is_published == 1 ? true : null;
                        $valueTwo = $variation->is_published == 1 ? true : null;
                    @endphp

                    <label for="valueOne" class="form-label">
                        {!! Form::radio('is_published', '1', $valueOne, ['id' => 'valueOne']) !!} Publier ?
                    </label>

                    &nbsp;&nbsp;&nbsp;

                    <label for="valueTwo" class="form-label">
                        {!! Form::radio('is_published', '0', $valueTwo, ['id' => 'valueTwo']) !!} Mettre en attente ?
                    </label>

        ...
        <div class="card card-info">
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    {!! Form::label('name', 'Entrer la dénomination du rôle*') !!}
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        {!! Form::select('permission[]', $permissions, null, ['class' => 'form-control select2 select2-select', 'multiple' => 'multiple']) !!}

                    </div>

                    <span class="text-danger text-sm">{{ $errors->first('permission') }}</span>

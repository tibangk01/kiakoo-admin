<x-layouts.app>
    ...
    <div class="row">
        ...
        <div class="col-sm-12 text-left py-3">
            ...
            <a href="{{ route('packing.edit', $packing) }}" class="btn btn-sm btn-info">
                <i class="fa fa-edit" aria-hidden="true"></i> ÉDITER
            </a>

            <a href="{{ route('packing.delete', $packing) }}" class="btn btn-sm btn-danger">
        ...
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-header">
                    ...
                    <h3 class="card-title">DETAIL DU CONDITIONNEMENT</h3>

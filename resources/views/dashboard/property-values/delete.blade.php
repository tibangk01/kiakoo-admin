        ...
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-header">
                    ...
                    <h3 class="card-title">SUPPRESSION DE LA VALEUR DE PROPRIÉTÉ</h3>
                                    ...
                                    <thead>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-bold" colspan="2">
                                                ...
                                                {!! Form::model($propertyValue, ['route' => ['property-value.destroy', $propertyValue->id], 'method' => 'DELETE', 'class' => 'form-horizontal']) !!}

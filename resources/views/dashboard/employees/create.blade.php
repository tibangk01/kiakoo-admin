                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        {!! Form::select('work_id', $works, null, ['class' => 'form-control select2', 'required' => true, 'placeholder' => 'Sélectionner une fonction']) !!}
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        {!! Form::select('gender_id', $genders, null, ['class' => 'form-control', 'required' => true, 'placeholder' => 'Sélectionner un genre']) !!}
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        {!! Form::text('last_name', null, ['class' => 'form-control', 'required' => true, 'placeholder' => 'Entrer un nom']) !!}
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        {!! Form::text('first_name', null, ['class' => 'form-control', 'required' => true, 'placeholder' => 'Entrer un prénom']) !!}
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        {!! Form::textarea('address', null, ['class' => 'form-control', 'rows' => '5', 'cols' => '5', 'maxlength' => '255', 'placeholder' => 'Entrer une adresse']) !!}
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        {!! Form::text('phone_number', null, ['class' => 'form-control', 'required' => true, 'placeholder' => 'Entrer un N° de téléphone']) !!}
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        {!! Form::email('email', null, ['class' => 'form-control', 'required' => true, 'placeholder' => 'Entrer un email']) !!}
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        {!! Form::select('role[]', $roles, null, ['class' => 'form-control select2 select2-select', 'multiple' => 'multiple']) !!}
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        {!! Form::select('permission[]', $permissions, null, ['class' => 'form-control select2 select2-select-bis', 'multiple' => 'multiple']) !!}
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <label for="valueOne" class="form-label">
                                        {!! Form::radio('authorized_to_log_in', '1', true, ['id' => 'valueOne']) !!} Employé Actif ?
                                    </label>

                                    &nbsp;&nbsp;&nbsp;

                                    <label for="valueTwo" class="form-label">
                                        {!! Form::radio('authorized_to_log_in', '0', null, ['id' => 'valueTwo']) !!} Employé Dormant ?
                                    </label>

    ...
    <div class="col-md-12">
        ...
        <div class="card card-info">
            ...
            <div class="card-header">
                ...
                <h3 class="card-title">Ajouter une fonction </h3>
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    {!! Form::label('name', 'Entrer la dénomination de la fonction') !!}

                    <div class="input-group">

                        {!! Form::text('name', null, ['class' => 'form-control', 'required' => true, 'autofocus' => '']) !!}

<x-layouts.app>
    ...
    <div class="row">
        ...
        <div class="col-sm-12 text-left py-3">
            <a href="{{ route('work.create') }}" class="btn btn-sm btn-info">
                <i class="fa fa-plus" aria-hidden="true"></i> AJOUTER UNE FONSTION
            </a>
        </div>
        ...
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-header">
                    ...
                    <h3 class="card-title">LISTE DES FONSTIONS</h3>

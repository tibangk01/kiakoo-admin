...
class CreateKiakooV2Table extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('products', function (Blueprint $table) {
            ...
            $table->string('sku')->nullable()->unique('sku');
            $table->string('name')->unique('name');
            $table->longText('description');
            $table->decimal('price', 12);
            $table->decimal('discount', 10, 0)->default(0);
            $table->decimal('stock', 12);
...
2 = client');
        ...
        Schema::table('products', function (Blueprint $table) {
            $table->foreign(['state_id'], 'products_ibfk_2')->references(['id'])->on('states')->onUpdate('CASCADE')->onDelete('CASCADE');
